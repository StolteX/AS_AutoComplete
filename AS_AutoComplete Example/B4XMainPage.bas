...
Private Sub B4XPage_Created (Root1 As B4XView)
	...
	AS_AutoComplete1.SetCustomLayout(TextField1.Left,TextField1.Top + TextField1.Height + 20dip,TextField1.Width,400dip)
	AS_AutoComplete1.StandoutTextField = False
